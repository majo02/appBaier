...
class PantallaBuscadosVoz extends StatefulWidget { 
  final String alimentoAmostrarNombre; 
  PantallaBuscadosVoz ({this.alimentoAmostrarNombre}); 
  @override 
...
class _PantallaBuscadosEstado extends State<PantallaBuscadosVoz> { 
